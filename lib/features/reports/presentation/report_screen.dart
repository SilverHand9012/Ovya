                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _PreviewRow(icon: Icons.personal_injury, text: 'Demographics & generated date'),
                      const SizedBox(height: 12),
                      _PreviewRow(icon: Icons.analytics_outlined, text: 'Computed risk score & PCOS type hint'),
                      const SizedBox(height: 12),
                      _PreviewRow(icon: Icons.list_alt, text: 'Last 30 days of symptom logs table'),
                      const SizedBox(height: 12),
                      _PreviewRow(icon: Icons.health_and_safety, text: 'Personalised recommendations'),
                    ],
                  ),
                ),
